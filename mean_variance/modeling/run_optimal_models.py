...
exp_params = {
    #'mean_variance': {'tau': [0.05], 'reg_params': [20]},
    #'dr_mean_variance': {'reg_params': [20], 'tau': [0.05], 'rho': [0.05]},
    #'cond_mean_variance': {'reg_params': [20], 'tau': [0.05], 'neighbor_quantile': [0.5]},
    #'dr_winf_cond_mean_variance': {'reg_params': [20], 'tau': [0.05], 'gamma_quantile': [0.2], 'rho_quantile': [0.1]},
    #'dr_w2_cond_mean_variance': {'reg_params': [20], 'tau': [0.05],  'epsilon': [ 0.1], 'rho_div_rho_min':  [1.05]},#[1.1,1.2,1.5]},
    #'dr_trim_cond_mean_variance': {'reg_params': [0.5], 'tau': [0.05],  'gamma': [0.05,0.1,0.25], 'rho_quantile':  [0.2,0.3,0.5]},
